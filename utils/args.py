...
def add_argument_base(arg_parser):
    ...
    arg_parser.add_argument('--sub_logdir', default='', type=str)
    arg_parser.add_argument('--finetune', action='store_true', help='finetune the large model')
    arg_parser.add_argument('--hfactor', default=0, type=float)
    return arg_parser